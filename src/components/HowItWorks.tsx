        ...
        <div className="bg-gray-50 rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-10 items-center shadow-sm border border-gray-100">
          ...
          <div className="w-full md:w-3/5 flex flex-col gap-2">
            ...
            <div className="mt-4 ml-1">
              <Link
                href="#formulario"
                className="inline-flex items-center gap-2 bg-[#005FB9] hover:bg-[#00519D] text-white font-bold px-7 py-3.5 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-0.5 text-sm"
              >
